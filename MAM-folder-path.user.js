...
if (series != "") {
    var folderPath = `/home/himmuch/torrents/qbittorrent/_Audiobooks/${author} - ${series}/Book ${bookOfSeries} - ${bookTitle}`;
    var folderPath2 = `/home/himmuch/torrents/qbittorrent/_Audiobooks1/${author} - ${series}/Book ${bookOfSeries} - ${bookTitle}`;
